...
- **Color use**: `GxEPD_RED` for severe weather icon (WMO codes 56,57,66,67,75,82,86,95,96,99), for current temp ≥ 30 °C / 86 °F, for forecast max ≥ 30 °C / 86 °F, and for forecast min < 0 °C / 32 °F. The separator ` ... ` in the min–max line is always black.
