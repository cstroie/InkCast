...
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS*/ 7, /*DC=*/ 8, /*RST=*/ 9, /*BUSY=*/ 10, /*MOSI=*/ 6, /*SCK=*/ 4)); // ESP32C3 Dev Board
// SDA 6 (MOSI)
// SCL 4 (SCK)
// CS 7
// D/C 8
