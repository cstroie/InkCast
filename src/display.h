...
//GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS*/ SS, /*DC=*/ 8, /*RST=*/ 9, /*BUSY=*/ 10)); // ESP32C3 Dev Board // SDA:6 (MOSI) SCL:4 (SCK)
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS=*/ 10, /*DC=*/ 3, /*RST=*/ 1, /*BUSY=*/ 0)); // SPI2: MOSI=GPIO7, SCK=GPIO6, CS=GPIO10 (native IO MUX)
#else
